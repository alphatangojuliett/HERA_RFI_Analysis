...
def xrfi(d, f=None, K=8, sig_init=5.0, sig_adj=2): #ATJ orig values: d, f=None, K=8, sig_init=6, sig_adj=2, but now changing to values of 
#(ATJ, cont. ) https://github.com/HERA-Team/hera_qm/blob/master/hera_qm/xrfi.py, so sig_init = 5.0 now. 
